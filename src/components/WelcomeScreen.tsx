      ...
      <div className="max-w-md w-full bg-black border border-white/10 rounded-xl p-6 shadow-lg">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/70 text-sm mb-4">
            This application helps you ace technical interviews by generating local,
            offline AI-powered solutions to coding problems.
          </p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
          ...
          <p className="text-white/70 text-sm mb-3">
            Make sure Ollama is running locally at `http://localhost:11434`, then
            choose your preferred local model in Settings.
          </p>
          <Button 
