      ...
      <div className="pt-2 w-fit">
        <div className="text-xs text-white/90 backdrop-blur-md bg-black/60 rounded-lg py-2 px-4 flex items-center justify-center gap-4">
          ...
          <div
            ...
            onClick={async () => {
              try {
                const result = await window.electronAPI.uploadScreenshot()
                if (!result.success) {
                    ...
                    <div className="space-y-3">
                      ...
                      <div
                        ...
                        onClick={async () => {
                          try {
                            const result =
                              await window.electronAPI.uploadScreenshot()
                            if (!result.success) {
                              console.error(
                              ...
                              showToast(
                                "Error",
                                result.error || "Failed to upload screenshot",
                                "error"
                              )
                            }
                          } catch (error) {
                      ...
                      >
                        ...
                        <p className="text-[10px] leading-relaxed text-white/70 truncate mt-1">
                          Upload a screenshot file of the question code.
                        </p>
                      </div>
                    ...
                    <div className="pt-3 mt-3 border-t border-white/10">
                      <div className="mb-3 px-2 space-y-1">
                        ...
                        <p className="text-[11px] text-white/50">
                          Shortcut: {COMMAND_KEY}+Shift+I
                        </p>
                      </div>

                      <div className="mb-3 px-2 space-y-1">
                        <div className="flex items-center justify-between text-[13px] font-medium text-white/90">
                          <span>Mouse Passthrough</span>
                          <button
                            className="bg-white/10 hover:bg-white/20 px-2 py-1 rounded text-[11px]"
