...
export class ShortcutsHelper {
  ...
  public registerGlobalShortcuts(): void {
    ...
    globalShortcut.register("CommandOrControl+Shift+I", () => {
      const enabled = this.deps.toggleInvisibilityMode()
      console.log(
        `Command/Ctrl + Shift + I pressed. Invisibility mode ${enabled ? "enabled" : "disabled"}.`
      )
    })

    globalShortcut.register("CommandOrControl+Shift+M", () => {
      const enabled = this.deps.toggleMousePassthroughMode()
      console.log(
        `Command/Ctrl + Shift + M pressed. Mouse passthrough ${enabled ? "enabled" : "disabled"}.`
      )
    })
